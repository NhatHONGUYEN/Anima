              ...
              <div className="flex w-full max-w-96 shrink flex-col items-center justify-between gap-6 lg:items-start">
                <div>
                  ...
                  <p className="mt-6  ">
                    ...
                    to classic favorites. Each anime comes with detailed
                    information, including its title, trailers, reviews, episode
                    list, production details, and more. Whether you&apos;re
                    searching for your next binge or learning more about your
                    favorite shows, Anima has everything you need to dive deeper
